...
## Training Results
```
Loaded featured_data.csv: (568, 41)
Features: 40 numeric | 0 categorical
Train: (454, 40) | Test: (114, 40)
MODEL: LogisticRegression — ACC=0.7719 F1=0.7693 RECALL=0.7719 AUC=0.8171 PR_AUC=0.8865

MODEL: RandomForestClassifier — ACC=0.7018 F1=0.6913 RECALL=0.7018 AUC=0.7774 PR_AUC=0.8624
MODEL: XGBClassifier — ACC=0.7281 F1=0.7287 RECALL=0.7281 AUC=0.7755 PR_AUC=0.8637
MODEL: LGBMClassifier — ACC=0.7193 F1=0.7193 RECALL=0.7193 AUC=0.7669 PR_AUC=0.8471
TUNING: Default improved params (small dataset)
OPTIMAL THRESHOLD: 0.50
FEATURE IMPORTANCE:
  num__worst concave points: 0.6984
  num__worst radius: 0.6115
  num__area error: 0.3996
  num__radius error: 0.3174
  num__mean radius: 0.2836
  num__worst perimeter: 0.2641
  num__mean perimeter: 0.2561
  num__worst texture: 0.2141
  num__smoothness error: 0.2135
  num__mean compactness: 0.1810

LEARNING CURVE: 6 sizes computed
...
TUNED SCORE: 0.7693
IMPROVEMENT: 0.0000
VISUALIZATION_JSON_SAVED
PIPELINE COMPLETE: LogisticRegression | tuned_metric=0.7693 | threshold=0.50
```
